...
const rows = [
  {
    imgsrc: img1,
    pname: "Nike branding shoes for Men and Women",
  ...
  {
    imgsrc: img2,
    pname: "Supreme toys presents best gift",
    customer: "John Deo",
  ...
  {
    imgsrc: img3,
    pname: "Red color shoes from Gucci",
  ...
  {
    imgsrc: img4,
    pname: "Stylish sneakers for men and women",
